...
\begin{document}
	...
	\begin{minibloque}[Definiciones]
		\begin{itemize}
			...
			\item \textbf{Naturalismo:} 
			\item \textbf{Cientificismo:} 
			\item \textbf{Materialismo:} Postura ontológica que afirma que todo lo existente se reduce a materia y energía. La mente, la conciencia y los valores morales son vistos como meros subproductos de procesos físicos.
			\item \textbf{Postmodernismo:} Corriente de pensamiento caracterizada por el escepticismo hacia las meta-narrativas absolutas (incluyendo la religión y la ciencia pura) y la fragmentación de la verdad objetiva en interpretaciones individuales.
			\item \textbf{Posteísmo:} Movimiento que sostiene que la pregunta sobre la existencia de Dios y el debate teísta/ateísta han quedado superados o vueltos obsoletos por el desarrollo cultural y tecnológico de la humanidad.
		\end{itemize}
	\end{minibloque}
	...
	\begin{minibloque}[Objeción]
		No me parece que exista Dios, ¿para qué perder el tiempo investigando algo que no veo relevante?
	\end{minibloque}
	
	\begin{itemize}
		\item \textbf{La ilusión de la neutralidad:} La indiferencia no es una postura neutra; es una toma de postura implícita. Al decidir no buscar, estás asumiendo en la práctica que la respuesta es <<No>> y aceptando todas sus consecuencias existenciales.
		\item \textbf{Asimetría del riesgo (La gravedad de la pregunta):} En cualquier ámbito de la vida, la intensidad de una investigación depende de lo que hay en juego. Si la probabilidad de que haya Dios fuera solo del 1\%, el impacto de su existencia sobre el origen del universo, la moral objetiva y el destino eterno sigue haciendo que ignorarlo sea irracional.
		\item \textbf{El parasitismo moral secular:} El agnóstico apático suele querer disfrutar de derechos humanos, dignidad e igualdad mientras ignora la pregunta sobre Dios. Sin embargo, no puede justificar de dónde salen esos valores objetivos en un universo puramente material.
	\end{itemize}
